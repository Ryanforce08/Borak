...
public class Java6 {
	...
	public static void main(String[] args) {
		...
		//returns the posision of substring s2 in string s1
		//returns int
		...
		//compares the stings lexicographically. returns negitive int if it comes befor and a positive if it comes after.
		//returns int
